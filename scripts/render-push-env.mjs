...
const env = {
  ...
  REDIS_URL: trim(fileEnv.REDIS_URL ?? 'redis://red-d8fkm1a8qa3s73addtng:6379'),
  REDIS_HOST: trim(fileEnv.REDIS_HOST ?? 'red-d8fkm1a8qa3s73addtng'),
  REDIS_PORT: trim(fileEnv.REDIS_PORT ?? '6379'),
  REDIS_PASSWORD: trim(fileEnv.REDIS_PASSWORD ?? ''),
