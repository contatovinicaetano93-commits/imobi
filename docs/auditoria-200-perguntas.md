...
8 roles ativos em `UsuarioTipo` (+ `GESTOR` legado no enum, normalizado para `GESTOR`): ADMIN, **GESTOR (Gestor do Fundo — único gestor)**, TOMADOR, TOMADOR, ENGENHEIRO, ENGENHEIRO, PARCEIRO, PARCEIRO.  
