...
const ROLE_RULES: Array<{ prefix: string; roles: string[] }> = [
  ...
  { prefix: "/dashboard/comercial",  roles: ["PARCEIRO", "ADMIN"] },
  { prefix: "/dashboard/construtor", roles: ["TOMADOR", "ADMIN"] },
  { prefix: "/dashboard/credito",    roles: ["TOMADOR", "ADMIN"] },
  { prefix: "/dashboard/obras",      roles: ["TOMADOR", "GESTOR", "ENGENHEIRO", "ADMIN"] },
  { prefix: "/dashboard/kyc",        roles: ["TOMADOR", "ADMIN"] },
  { prefix: "/dashboard/score",      roles: ["TOMADOR", "ADMIN"] },
  { prefix: "/dashboard/simulador",  roles: ["TOMADOR", "ADMIN"] },
  { prefix: "/dashboard/comite",     roles: ["TOMADOR", "GESTOR", "ENGENHEIRO", "ADMIN"] },
];
