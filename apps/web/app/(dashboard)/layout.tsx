...
const NAV: NavItem[] = [
  ...
  { label: "Viabilidade",   href: "/dashboard/viabilidade",             icon: FileText,    roles: ["TOMADOR", "CONSTRUTOR"],           funcao: "kyc" },
  ...
  { label: "KYC",           href: "/dashboard/gestor/kyc",              icon: FileCheck2,  roles: ["ADMIN"] },
