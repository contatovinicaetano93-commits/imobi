...
export default function RelatoriosPage() {
  ...
  const filaElevada = kycPendentes > 10 || ov.etapasPendentes > 10;

  const panels = useMemo(
    () => [
      ...(filaElevada ? [{ id: "rel-alertas", priority: "critical" as const }] : []),
      { id: "rel-kpis", priority: "primary" as const },
      { id: "rel-graficos", priority: "primary" as const },
      { id: "rel-resumo", priority: "primary" as const },
      { id: "rel-atalhos", priority: "secondary" as const },
    ],
    [filaElevada],
  );
  ...
  if (loading) {
    return (
      <div className="max-w-6xl p-4 sm:p-6 space-y-6">
        ...
        <>
          ...
          {filaElevada && (
            <PanelSection
              ...
              priority="critical"
              badge={kycPendentes + ov.etapasPendentes}
              summary={`${kycPendentes} KYC · ${ov.etapasPendentes} etapas`}
              urgency="critical"
            >
          ...
          <PanelSection
            ...
            priority="primary"
            summary={`${brl(ov.creditoLiberado)} liberado · ${kycPendentes} KYC pendentes`}
          >
          ...
          <PanelSection
            id="rel-graficos"
            title="Gráficos operacionais"
            icon={<LineChart className="w-4 h-4 text-[#1B4FD8]" />}
            priority="primary"
            summary="Crédito liberado e obras por status"
          >
          ...
          <PanelSection
            ...
            priority="primary"
            summary={`${ov.totalUsuarios} usuários · ${ov.obrasTotal} obras`}
          >
