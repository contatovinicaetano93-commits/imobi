...
export default function ComercialPerfil() {
  ...
  return (
    <View style={s.root}>
      ...
      <View style={s.header}>
        <View style={s.avatar}>
          <Text style={s.avatarText}>{perfil?.nome?.slice(0, 2).toUpperCase() ?? "PC"}</Text>
        </View>
        <Text style={s.nome}>{perfil?.nome ?? "Parceiro Comercial"}</Text>
        <Text style={s.email}>{perfil?.email ?? ""}</Text>
        <View style={s.roleBadge}>
          <Text style={s.roleText}>Parceiro Comercial</Text>
        </View>
      </View>
