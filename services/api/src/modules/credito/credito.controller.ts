...
export class CreditoController {
  ...
  @ApiOperation({
    ...
    description:
      "Simula condições de crédito sem criar solicitação (endpoint público)",
  })
  ...
  @ApiOperation({
    ...
    description: "Cria uma nova solicitação de crédito autenticado",
  })
  ...
  @ApiBearerAuth()
  @ApiOperation({
    summary: "Meus créditos",
    description: "Lista créditos do usuário autenticado",
  })
