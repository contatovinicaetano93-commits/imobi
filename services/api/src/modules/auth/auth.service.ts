  ...
  async registrar(input: CadastroUsuarioInput) {
    ...
    const usuario = await this.prisma.usuario.create({
      data: {
        ...
        consentidoTermosEm: input.consentidoTermos ? new Date() : null,
        consentidoPrivacy: input.consentidoPrivacy,
        consentidoPrivacyEm: input.consentidoPrivacy ? new Date() : null,
        consentidoKyc: input.consentidoKyc,
        consentidoKycEm: input.consentidoKyc ? new Date() : null,
        consentidoMarketing: input.consentidoMarketing ?? false,
        consentidoMarketingEm: input.consentidoMarketing ? new Date() : null,
