...
export class KycController {
  ...
  @ApiOperation({
    ...
    description: "Envia documento de identidade ou comprovante",
  })
  ...
  @ApiOperation({
    ...
    description: "Retorna documentos KYC do usuário",
  })
  ...
  @ApiOperation({
    ...
    description: "Retorna status atual do processo KYC",
  })
  ...
  async listarPendentes(@UsuarioAtual() u: IUsuario) {
    if (u.tipo !== "ADMIN" && u.tipo !== "GESTOR_OBRA") {
      throw new ForbiddenException(
        "Acesso restrito apenas para ADMIN e GESTOR_OBRA.",
      );
    }
  ...
  @Get("verificar")
  @ApiOperation({
    summary: "Verificar KYC completo",
    description: "Verifica se o KYC foi completado com sucesso",
  })
